...
public final class StaticDAO {
	...
	static {
		trainers.put("TRN101", new TrainerDTO("TRN101", "Rahul Verma", "", "trainer101", "rahulverma@gmail.com", true));
		trainers.put("TRN102", new TrainerDTO("TRN102", "Amit Deshpande", "", "trainer102", "amitdeshpande@gmail.com", true));
		trainers.put("TRN103", new TrainerDTO("TRN103", "Aman Jadhav", "", "trainer103", "amanjadhav@gmail.com", true));
		trainers.put("TRN104", new TrainerDTO("TRN104", "Raj Kashyap", "", "trainer104", "rajkashyap@gmail.com", true));

		students.put("STD101", new StudentDTO("STD101", "Om Gupta", "student101", "ogupta261@gmail.com", "A", true));
		students.put("STD102", new StudentDTO("STD102", "Raju Deka", "student102", "raju95@gmail.com", "A", true));
		students.put("STD103", new StudentDTO("STD103", "Amit Yadav", "student103", "amit067@gmail.com", "B", true));
		students.put("STD104", new StudentDTO("STD104", "Abhishek Yadav", "student104", "abhishek2002@gmail.com", "B", true));

		programs.put("PRG101", new ProgramDTO("PRG101", "DevOps", true));
		programs.put("PRG102", new ProgramDTO("PRG102", "Oracle", true));
		programs.put("PRG103", new ProgramDTO("PRG103", "MVC", true));
		programs.put("PRG104", new ProgramDTO("PRG104", "Spring", true));

		courses.put("CRS101", new CourseDTO("CRS101", "Java Cloud", true));
		courses.put("CRS102", new CourseDTO("CRS102", "Java Big Data", true));
		courses.put("CRS103", new CourseDTO("CRS103", "Java ", true));

		feedback.put("FDB101", new FeedbackDTO("FDB101", "STD101", "TRN101", "PRG101", 3, 4, 3, 4, 4, "Great.", "Nothing"));
		feedback.put("FDB102", new FeedbackDTO("FDB102", "STD102", "TRN101", "PRG101", 5, 4, 3, 3, 4, "Good.", "NA"));
		feedback.put("FDB103", new FeedbackDTO("FDB103", "STD102", "TRN102", "PRG103", 1, 1, 2, 2, 1, "BAD.", "everything"));
		feedback.put("FDB104", new FeedbackDTO("FDB104", "STD103", "TRN104", "PRG102", 5, 3, 4, 3, 5, "LOL.", "Heh!"));
